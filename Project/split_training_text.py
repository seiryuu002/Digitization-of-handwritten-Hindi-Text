...
training_text_file = 'langdata/hin.training_text'
...
output_directory = 'tesstrain/data/Devanagiri-ground-truth'
...
for line in lines:
    ...
    file_base_name = f'hin_{line_count}'
    ...
    subprocess.run([
        ...
        '--char_spacing=1.5',
        '--exposure=0',
        '--unicharset_file=langdata/hin.unicharset'
    ])
